...
I was originally a Biochemistry major at Penn State, but ultimately pursued a career in Computer Science.  I still have a desire to learn Biology, and recent advancements in machine learning and Bioinformatics have made it enticing to cross-train.  However, while trying to pursue this, I discovered that most Bioinformatics material is geared toward beginning as a Biologist or Biochemist and subsequently cross-training into Computer Science; the converse does not seem to exist in the way that would satisfy me intellectually.  In particular, I would like a fundamental understanding of the concepts so that I can understand the implications of the data to be processed.
...
* [ ] Organic Chemistry I
  * MIT OCW contains two Organic Chemistry courses
    * [ ] [5.12 - Organic Chemistry I](https://ocw.mit.edu/courses/5-12-organic-chemistry-i-spring-2005/) (Berkowski and O'Connor, Spring 2005)
